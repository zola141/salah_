...
export default function App() {
  ...
  if (shouldUseUrl) {
    // Explicit URL parameter takes precedence over roomCode
    const multiplayer = urlMultiplayer === "true" || (urlMultiplayer !== "false" && !!roomCode);
    const effectiveGameType = "1v1";
    const players = ["red", "yellow"];
    const bots = multiplayer ? [] : ["yellow"];
    
    console.log("[App.jsx] urlMultiplayer:", urlMultiplayer, "roomCode:", roomCode, "=> multiplayer:", multiplayer, "bots:", bots);
